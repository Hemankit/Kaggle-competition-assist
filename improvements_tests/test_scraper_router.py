...
try:
    from improvements.scraper_router.data_source_decider import DataSourceDecider
...
# Test 4: Scraper Router Integration
...
try:
    ...
    print("✅ Scraper Router: Working")
    
except Exception as e:
    print(f"❌ Scraper Router: Error - {e}")
